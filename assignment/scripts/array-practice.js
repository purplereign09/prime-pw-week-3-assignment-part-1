...
let favoriteFoods = ['salad', 'smoothie', 'burger'];
...
console.log('Removed the last food which was', removedFoods);
...
favoriteFoods.unshift('plantains');
console.log(`Added plaintains to the beginning: ${favoriteFoods}`);
